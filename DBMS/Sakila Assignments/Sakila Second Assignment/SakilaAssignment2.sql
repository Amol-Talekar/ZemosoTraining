...
select count(distinct film.title) as NumberofDocWithDeletedScenes
from film_category 
...
select count(*) as NumberofMoviesRentedBySusan from film_list,inventory,rental,customer
where rating='R'
and film_list.fid=inventory.film_id
